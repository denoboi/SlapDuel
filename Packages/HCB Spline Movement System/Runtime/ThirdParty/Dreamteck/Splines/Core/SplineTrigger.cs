namespace Dreamteck.Splines
{
    ...
    [System.Serializable]
    public class SplineUserEvent : UnityEvent<SplineUser> { }
    ...
    public class SplineTrigger
    {
        ...
        [SerializeField]
        [HideInInspector]
        public SplineUserEvent onUserCross = new SplineUserEvent();
        ...
        public SplineTrigger(Type t)
        {
            ...
            onUserCross = new SplineUserEvent();
        }
