...
internal class ToolbarStartFromFirstScene : BaseToolbarElement {
	...
	public override void Init() {
		...
		startFromFirstSceneBtn = new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath($"{GetPackageRootPath}/Editor/CustomToolbar/Icons/PlayButtonIcon.png", typeof(Texture2D)), "Start from 1 scene");
	}
