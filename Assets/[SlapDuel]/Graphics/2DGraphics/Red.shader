...
Shader "New Amplify Shader"
{
	Properties
	{
		_Postion("Postion", Range( 0 , 1)) = 0
		_smoothGeceis("smoothGeceis ", Range( 0 , 20)) = 1.64
		_color2("color2", Color) = (1,0,0,0)
		_Color1("Color 1", Color) = (0,0.9073796,1,0)
	...
	LOD 0
		...
		Pass
		{
			...
			uniform float _Postion;
			uniform float _smoothGeceis;
			...
			v2f VertexFunction (appdata v  ) {
				...
				o.ase_texcoord9.xy = v.texcoord1.xyzw.xy;
				...
				) : SV_Target 
			{
				...
				float4 lerpResult15 = lerp( _color2 , _Color1 , saturate( ( ( texCoord6.y - (-0.2 + (_Postion - 0.0) * (1.0 - -0.2) / (1.0 - 0.0)) ) * _smoothGeceis ) ));
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				o.ase_texcoord3.xy = v.texcoord1.xyzw.xy;
...
/*ASEBEGIN
Version=18921
727;73;654;587;1364.755;225.4991;1.376837;True;False
Node;AmplifyShaderEditor.SimpleSubtractOpNode;12;-547.1472,6.572174;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;15;104.3881,305.0327;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;19;-196.6326,529.7802;Inherit;False;Property;_Color1;Color 1;3;0;Create;True;0;0;0;False;0;False;0,0.9073796,1,0;0,0.9073796,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;6;-824.0071,-95.13138;Inherit;True;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-293.0351,98.07007;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;20;-17.86365,159.8098;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1082.403,176.3133;Inherit;False;Property;_Postion;Postion;0;0;Create;True;0;0;0;False;0;False;0;0.75;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-193.6326,361.7802;Inherit;False;Property;_color2;color2;2;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;8;-464.4567,274.4938;Inherit;False;Property;_smoothGeceis;smoothGeceis ;1;0;Create;True;0;0;0;False;0;False;1.64;1.64;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;14;-788.9768,185.3577;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-0.2;False;4;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=9048B83BAFBAAEAEE9C22CEC68D810B4944378B2